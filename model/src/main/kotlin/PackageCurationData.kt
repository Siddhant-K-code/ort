...
data class PackageCurationData(
    ...
    val declaredCopyrights: SortedSet<String>? = null,
    ...
    fun apply(targetPackage: CuratedPackage): CuratedPackage {
        ...
        val copyrightHolders = declaredCopyrights ?: original.copyrightHolders
    ...
    fun merge(other: PackageCurationData) =
        PackageCurationData(
            ...
            declaredCopyrights = (declaredCopyrights.orEmpty() + other.declaredCopyrights.orEmpty()).toSortedSet(),
